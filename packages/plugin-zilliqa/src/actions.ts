    ...
    const actionsWithoutHandler = [
        {
          ...
          examples: [
            [ { user: "{{user1}}",
                content: { text: "Tell me the balance of account 0xf0cb24ac66ba7375bf9b9c4fa91e208d9eaabd2e" },
              },
              { user: "{{agentName}}",
                content: { text: "The balance of account 0xf0cb24ac66ba7375bf9b9c4fa91e208d9eaabd2e is 2.01 zil",
                           action: "GET_BALANCE"
                         }
              }
            ]
